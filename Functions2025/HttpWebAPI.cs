...
[HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students")] HttpRequestData req)
    ...
    public HttpResponseData GetStudentCountBySchool(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students/schools/count")] HttpRequestData req)
    {
        _logger.LogInformation("Fetching student count by school.");
    ...
    public HttpResponseData GetStudentsBySchool(
        ...
        string school)
    {
        _logger.LogInformation($"Fetching students from school: {school}");
